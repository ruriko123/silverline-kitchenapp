...
exports.activeOperatingLocation = void 0;
const app_data_source_1 = __importDefault(require("../../../app-data-source"));
const TbloperatingLocations_1 = require("../../../ORM/entities/TbloperatingLocations");
const activeOperatingLocation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        if (!locationexists) {
            ...
            yield app_data_source_1.default
                .createQueryBuilder()
                .update(TbloperatingLocations_1.TbloperatingLocations)
                .set({ isActive: true })
                .where("id = :id", { id: id })
                .execute();
            res
...
exports.activeOperatingLocation = activeOperatingLocation;
